  ...
  if (loading)
    return (
      <div className="container mx-auto px-4 py-12">
        <div className="aspect-[16/9] bg-muted animate-pulse rounded-2xl max-w-5xl mx-auto" />
      </div>
    );
              ...
              <>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      min={1}
                      value={autistas}
                      onChange={(e) => setAutistas(+e.target.value)}
                      className="mt-1"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="mt-1"
                    rows={3}
                    placeholder="Necessidades específicas, dúvidas..."
                  />
                </div>
